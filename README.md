...
xadmin3.0版本已经完全重写，完全变成了一个纯前端框架。全新的xadmin使用React和Jotai套餐，保持了xadmin原有的高扩展性和高定制性，让您可以轻松定制出一整套管理后台。后端数据全部采用API方式获取，您可以定制自己的API Client对接您的后台系统。
...
详细文档请见 [Xadmin文档中心](./docs/README.md)
...
|---------|---------|------|-------------|
|xadmin|3.0.2||xadmin核心模块|
|xadmin-i18n|3.0.2||i18n国际化功能模块|
|xadmin-form|3.0.2||xadmin表单模块|
|xadmin-model|3.0.2||xadmin模型模块|
|xadmin-auth|3.0.2||xadmin用户权限模块|
|xadmin-antd|3.0.2||xadmin Antd UI模块包|
|xadmin-plugins|3.0.2||xadmin常用插件|
