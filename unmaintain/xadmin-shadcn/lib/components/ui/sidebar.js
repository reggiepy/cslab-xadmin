...
var Sidebar = exports.Sidebar = /*#__PURE__*/React.forwardRef((_ref2, ref) => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: (0, _utils.cn)("fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex", side === "left" ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]" : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
...
var SidebarGroupLabel = exports.SidebarGroupLabel = /*#__PURE__*/React.forwardRef((_ref12, ref) => {
  ...
  return /*#__PURE__*/React.createElement(Comp, _extends({
    ...
    className: (0, _utils.cn)("flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", className)
  }, props));
});
...
var SidebarMenuBadge = exports.SidebarMenuBadge = /*#__PURE__*/React.forwardRef((_ref19, ref) => {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: (0, _utils.cn)("pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground", "peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[active=true]/menu-button:text-sidebar-accent-foreground", "peer-data-[size=sm]/menu-button:top-1", "peer-data-[size=default]/menu-button:top-1.5", "peer-data-[size=lg]/menu-button:top-2.5", "group-data-[collapsible=icon]:hidden", className)
  }, props));
});
...
var SidebarMenuSkeleton = exports.SidebarMenuSkeleton = /*#__PURE__*/React.forwardRef((_ref20, ref) => {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: (0, _utils.cn)("flex h-8 items-center gap-2 rounded-md px-2", className)
