  ...
  return /*#__PURE__*/React.createElement(_reactDayPicker.DayPicker, _extends({
    ...
    components: {
      IconLeft: _ref2 => {
        ...
        return /*#__PURE__*/React.createElement(_lucideReact.ChevronLeft, _extends({
          className: (0, _utils.cn)("h-4 w-4", className)
        }, props));
      },
      IconRight: _ref3 => {
        var {
        ...
        return /*#__PURE__*/React.createElement(_lucideReact.ChevronRight, _extends({
          className: (0, _utils.cn)("h-4 w-4", className)
        }, props));
      }
    }
