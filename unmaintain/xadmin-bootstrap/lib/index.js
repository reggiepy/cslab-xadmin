...
var _default = exports.default = {
  ...
  components: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
    Main: _layout.Main,
    App: _layout.App,
    Page: _layout.Page,
    Loading: _layout.Loading,
    Icon: _layout.Icon
  }, _components.default), _form.default.components), _model.default.components), _filter.default.components), _relate.default.components), _auth.default.components),
  routers: _layout.default,
